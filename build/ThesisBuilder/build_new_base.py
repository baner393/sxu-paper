#!/usr/bin/env python3
"""Update Program.cs for paper 6 (老年人再就业权益保障研究) - base info."""
import os
...
# 1. Output filename
cs = cs.replace(
    '新时代青年精神内耗的成因及化解路径.docx',
    '积极老龄化视角下老年人再就业权益保障研究.docx'
)

# 2. Header year -- keep 2026级 as per template

# 3. Chinese abstract
old_cn = '新时代背景下，社会加速转型、数智技术深度渗透与多元文化思潮交织，使青年群体普遍面临学业、就业、人际、发展等多重压力，精神内耗已从个体心理现象上升为具有普遍性的社会问题，对青年身心健康、价值塑造、人格完善与成长发展构成现实影响。为系统把握这一议题的研究脉络，本文以“新时代青年精神内耗”为核心对象，采用文献研究法、跨学科研究法与归纳总结法，对国内近五年相关期刊论文、学位论文及研究成果进行全面梳理与整合论述。文章首先界定精神内耗的核心内涵与主要特征，归纳青年精神内耗在心理情绪、行为选择、价值认知、社会适应等方面的现实表征；其次从社会环境、高校教育、数字媒介、家庭影响及青年自身五个维度，系统梳理学界关于精神内耗生成原因的主要观点；再次整合提炼价值引领、教育优化、媒介治理、社会支持、个体调适等化解路径；最后对现有研究成果进行评述，指出研究不足并展望未来方向。研究表明，青年精神内耗是外部压力传导与内在认知失衡共同作用的结果，其治理需要构建社会、学校、家庭、个人协同联动的综合体系。'
new_cn = '当前我国社会经济持续高速高质量发展，人口老龄化现象加速演进已经成为社会发展的必然结果，我国老年人口规模不断扩大，也出现了不同需求的老年群体。诸多身体条件尚可、渴望重新工作的老年群体，在上一份工作终止后就业受阻，使得劳动力资源没能得到充分利用。促进老年人再就业是实施积极应对人口老龄化国家战略的重要途径之一。在人口老龄化持续加剧与延迟退休政策逐步落地的背景下，我国老年人口再就业规模不断扩大，已经成为劳动力市场和养老保障体系中的重要变量。研究老年人再就业权益保障，回应老年人权益保障的现实诉求，有利于实现“老有所为”，推动我国经济发展。\n\n本文主要研究从积极老龄化角度出发，结合我国人口老龄化现状以及相关的就老龄化政策，分析了我国老年人再就业现状与影响老年人再就业的因素，分别是个人自身、家庭环境、社会市场、政策制度四种因素，指出了当前老年人再就业可能遇到的困境，立足社会现实与老龄化发展趋势，提出了老年人再就业的保障路径：从政策完善、权益维护、岗位优化、技能提升、社会引导等多方面构建完整保障体系。'
cs = cs.replace(old_cn, new_cn)

# 4. CN Keywords
cs = cs.replace(
    '新时代青年；精神内耗；成因；化解路径；思想政治教育',
    '积极老龄化；社会保障；老年人再就业；劳动权益保障'
)
...
new_cover = '''            ("中文题目", "积极老龄化视角下老年人再就业权益保障研究", false),
            ("英文题目", "Research on the Protection of Rights and Interests of the Elderly in Reemployment from the Perspective of Active Aging", true),
            ("姓名", "谢玉章", false),
...
new_ack = '本论文的顺利完成，离不开指导教师刘春荣教授的悉心指导与同学们的帮助。在论文写作过程中，我深入学习了文献研究法、归纳总结法等学术研究方法，对积极老龄化视角下老年人再就业权益保障这一议题有了更深刻的认识。同时也认识到自身在理论分析与实证研究方面尚存在诸多不足。今后将继续努力，不断提升自身的学术素养与研究能力，为社会保障事业贡献自己的力量。感谢所有在论文写作过程中给予我支持与帮助的人。'
cs = cs.replace(old_ack, new_ack)

with open(CS, 'w', encoding='utf-8', newline='\r\n') as f:
    f.write(cs)
print("Base info updated!")
